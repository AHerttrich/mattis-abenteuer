...
const ENCHANT_DEFS: EnchantmentDef[] = [
  {
    ...
    name: 'Fire Aspect',
    icon: '🔥',
    description: 'Target burns for 3s',
    cost: [
  ...
  {
    id: Enchantment.KNOCKBACK,
    name: 'Knockback',
    icon: '💨',
    description: '2x knockback distance',
    cost: [
  ...
  {
    id: Enchantment.LIFESTEAL,
    name: 'Lifesteal',
    icon: '❤️‍🔥',
    description: 'Heal 20% of damage',
    cost: [
  ...
  {
    id: Enchantment.SPEED,
    name: 'Haste',
    icon: '⚡',
    description: '+30% attack/mine speed',
    cost: [
...
export class EnchantSystem {
  ...
  getEnchantments(): EnchantmentDef[] {
    return ENCHANT_DEFS;
  }
